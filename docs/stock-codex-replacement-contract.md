...
`0.143.0`, auth-persistence thread `019f4633-1fd1-7a43-b59c-f99bc92fe1bc`,
and live thread `019f4634-96b6-7673-bd18-c9c0b8db6b40`. The update-agent step
...
`scheduled_action=up-to-date` with `host_cache_referenced=False`.
