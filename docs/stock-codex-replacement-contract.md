...
<installed-runtime>/scripts/update_stock_codex_compat.py`, follows the current
launcher manifest instead of baking `--current-codex`, and omits proof-only
