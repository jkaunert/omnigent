...
XCODEBUILD_CLI_TOOL_NAME = "xcodebuildmcp_simulator_build_run"
XCODEBUILDMCP_MCP_SERVER_NAME = "XcodeBuildMCP"
XCODEBUILDMCP_CLI_COMMAND = ("xcodebuildmcp", "simulator", "build-and-run")
...
class XcodeBuildCliAdapterPolicy:
    ...
    tool_name: str = XCODEBUILD_CLI_TOOL_NAME
    mcp_server_name: str = XCODEBUILDMCP_MCP_SERVER_NAME
    command_prefix: tuple[str, ...] = XCODEBUILDMCP_CLI_COMMAND
